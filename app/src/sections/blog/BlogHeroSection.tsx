export default function BlogHeroSection() {
  return (
    <section className="relative min-h-[40vh] flex items-center justify-center bg-[#1a1a0e] overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 pt-24 pb-12">
        <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl text-white">Wellness Blog</h1>
        <p className="font-body text-white/80 mt-4 max-w-lg mx-auto">
          Insights, tips, and wisdom for your spiritual journey
        </p>
      </div>
    </section>
  );
