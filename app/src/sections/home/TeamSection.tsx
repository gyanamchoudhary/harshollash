    ...
    <section className="py-20 lg:py-28 bg-white relative overflow-hidden">
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <ScrollReveal className="mt-16">
          <div className="bg-yellow-50 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-lg max-w-6xl mx-auto card-lift">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="w-full md:w-[28rem] flex-shrink-0 rounded-2xl shadow-md">
                <img loading="lazy"
                  src={founder.image}
                  alt={founder.name}
